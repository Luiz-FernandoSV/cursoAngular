    ...
    public class LotesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Delete(int loteId, int eventoId)
        {
            try
            {
                ...
                return await _loteService.DeleteLote(lote.EventoId, lote.Id) ? Ok(new {message = "Lote Deletado"}) : throw new Exception("Ocorreu um erro não específico ao tentar deletar evento");
